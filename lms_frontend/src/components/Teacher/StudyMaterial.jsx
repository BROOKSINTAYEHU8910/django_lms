    ...
    <div className='container mt-4'>
        <div className='row'>
            ...
            <section className='col-md-9'>
                <div className='card'>
                    <h5 className='card-header'>All Study Material ({totalResult}) <Link className='btn btn-sm float-end btn btn-info ' to={'/add-study/'+course_id}>Add Study Material</Link> </h5>
